"""
This is Method-2. The code of this is 99% same as method 1 except 2 lines(ln 39 and 40 of Method1) which are removed here. This method 
is going to work on the english data + translated data of non english text, hence the two ine of code is removed.
